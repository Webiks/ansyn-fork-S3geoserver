...
function killService(service) {
    exec(`aws --region ${region} ecs list-tasks --cluster ${cluster} --service-name ${service}`, (error, stdout, stderr) => {
        console.log(stdout);
        console.log(stderr);
        ...
        arns.forEach(arn => {
            ...
            exec(`aws --region ${region} ecs stop-task --cluster ${cluster} --task ${task}`, (error, stdout, stderr) => {
                console.log(stdout);
                console.log(stderr);
                if (error !== null) {
